...
class View_staff(tk.Frame):
    def __init__(self,parent,controller):
        ...
        self.view=View_staff_Fram(self,controller)
...
class View_staff_Fram(tk.Frame):
    ...
    def onViewClick(self,parent,checker):
        ...
        c=conn.cursor()
        c.execute('select * from staff where phone=?;',(checker,))
        l=c.fetchall()
        if(len(l)==0):
            ...
            age=l[0][1]
            sal=l[0][3]
            tk.Label(parent,text="Staff ID: "+str(id),bg="#FFFDD0",fg="black",font=("Arial",17,"bold")).place(x=300,y=330)
            ...
            tk.Label(parent,text="Salary: "+str(sal),bg="#FFFDD0",fg="black",font=("Arial",17,"bold")).place(x=300,y=480)

    def __init__(self,parent,controller):
        tk.Frame.__init__(self, parent, bg="#FFFDD0", highlightbackground="black", highlightthickness=5)
        disp=tk.Label(parent,text="VIEW STAFF", bg="#FFFDD0",fg="#F99B03",font=("Helventica",35,"bold"))
